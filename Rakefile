...
task :default => ['draft-bormann-jsonpath-iregexp.v2v3.xml']
...
file 'draft-bormann-jsonpath-iregexp.v2v3.xml' => ['draft-bormann-jsonpath-iregexp.md', 'iregexp.rfc.out', 'iregexp.abnf']
