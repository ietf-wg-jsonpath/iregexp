...
task :default => ['draft-ietf-jsonpath-iregexp.v2v3.xml']
...
file 'draft-ietf-jsonpath-iregexp.v2v3.xml' => ['draft-ietf-jsonpath-iregexp.md', 'iregexp.rfc.out', 'iregexp.abnf']
